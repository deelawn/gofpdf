...
[![MIT
licensed](https://img.shields.io/badge/license-MIT-blue.svg)](https://raw.githubusercontent.com/deelawn/gofpdf/master/LICENSE)
[![Report](https://goreportcard.com/badge/github.com/deelawn/gofpdf)](https://goreportcard.com/report/github.com/deelawn/gofpdf)
[![GoDoc](https://img.shields.io/badge/godoc-GoFPDF-blue.svg)](https://godoc.org/github.com/deelawn/gofpdf)

![](https://github.com/deelawn/gofpdf/raw/master/image/logo_gofpdf.jpg?raw=true)
...
commit](https://github.com/deelawn/gofpdf/commit/603f56990463f011cb1dbb64ef7f872c1adc009a).
Tools such as
[active-forks](https://techgaun.github.io/active-forks/index.html#deelawn/gofpdf)
...
``` shell
go get github.com/deelawn/gofpdf
```

Later, to receive updates, run

``` shell
go get -u -v github.com/deelawn/gofpdf/...
```
...
[fpdf\_test.go](https://github.com/deelawn/gofpdf/blob/master/fpdf_test.go)
